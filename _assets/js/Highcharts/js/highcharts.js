...
(function() {
    ...
    E = {
        ...
        credits: {
            enabled: 0,
            text: "XL - Axiata, Jakarta Indonesia",
            href: "#",
            position: {
                align: "right",
                x: -10,
        ...
        Z = {
            ...
            pathToVML: function(a) {
                for (var b = a.length, c = []; b--;)
                    if (ja(a[b])) c[b] = v(a[b] * 10) - 5;
                    else if (a[b] === "Z") c[b] = "x";
                else if (c[b] = a[b], a.isArc && (a[b] === "wa" || a[b] === "at")) c[b + 5] === c[b + 7] && (c[b + 7] += a[b + 7] > a[b +
        ...
        var ia = {
            ...
            color: function(a, b, c, d) {
                ...
                if (i) {
                    ...
                    if (c === "fill")
                        if (i === "gradient") c = n.x1 || n[0] || 0, a = n.y1 || n[1] || 0, m = n.x2 || n[2] || 0, n = n.y2 || n[3] || 0, C = 'angle="' + (90 - V.atan((n - a) / (m - c)) * 180 / oa) + '"', u();
                        else {
                            var j = n.r,
                                r = j * 2,
                                v = j * 2,
    ...
    K.PlotLineOrBand.prototype = {
        render: function() {
            ...
            if (m)
                ...
                o.length && (a.svgElem = m = u.path(o).attr(r).add(), C))
    ...
    na.prototype = {
        ...
        defaultLabelFormatter: function() {
            ...
            if (h) g = Ja(h, this);
                ...
                for (; f-- && g === u;) c = Math.pow(1E3, f + 1), a >= c && e[f] !== null && (g = Ba(b / c, -1) + e[f]);
        ...
        getOffset: function() {
            var a = this,
                ...
                x, y, A, z, R;
            a.hasData = j = a.hasVisibleSeries || s(a.min) && s(a.max) &&
                !!e;
    ...
    na.prototype.normalizeTimeTickInterval = function(a, b) {
        ...
        for (g = 0; g < c.length; g++)
            if (d = c[g], e = A[d[0]], f = d[1], c[g + 1] && a <= (e * f[f.length - 1] + A[c[g + 1][0]]) / 2) break;
    ...
    O.prototype = {
            ...
            if (d !== !1 && h && g === h && !e.cropped && !e.hasGroupedData) q(a, function(a, b) {
                ...
                if (o && h > o) {
                    ...
                    if (ja(k)) {
                        ...
                        if (s)
                            for (c = 0; c < h; c++) i = a[c], r[c] = i[0], t[c] = i.slice(1, s + 1);
                        else
                            for (c = 0; c < h; c++) i = a[c], r[c] = i[0], t[c] = i[1];
                    else ha(12)
                } else
                    for (c = 0; c < h; c++)
                        if (a[c] !== u && (i = {
        ...
        generatePoints: function() {
            ...
            if (b && (g !== (c = b.length) ||
                    j))
                for (n = 0; n < c; n++)
                    if (n === h && !j && (n += g), b[n]) b[n].destroyElements(), b[n].plotX = u;
            this.data = b;
            this.points = l
        },
            ...
            if (l.enabled !== !1 || this._hasPointMarkers)
                for (f = b.length; f--;)
                    if (g = b[f], d = U(g.plotX), e = g.plotY, k = g.graphic, m = g.marker || {}, o = !!g.marker, a = s && m.enabled === u || m.enabled, q = c.isInsidePlot(v(d), e, c.inverted), a && e !== u && !isNaN(e) && g.y !== null)
                        if (a = g.pointAttr[g.selected ? "select" : ""] || n, h = a.r, i = p(m.symbol, this.symbol), j = i.indexOf("url") === 0, k) k[q ? "show" : "hide"](!0).animate(r({
                            x: d - h,
                            y: e - h
                        }, k.symbolName ? {
                            width: 2 * h,
    ...
    ia = ma(O, {
        ...
        getColumnMetrics: function() {
            var a = this,
                ...
                h, i = 0;
            b.grouping ===
                !1 ? i = 1 : q(a.chart.series, function(b) {
                    var c = b.options,
                        e = b.yAxis;
            ...
            return a.columnMetrics = {
                width: l,
                offset: b + (j + ((e ? i - (a.columnIndex || 0) : a.columnIndex) || 0) * k - c / 2) *
                    (e ? -1 : 1)
            }
        },
        translate: function() {
    ...
    O.prototype.drawDataLabels = function() {
        ...
        if (d.enabled || a._hasPointLabels) a.dlProcessOptions && a.dlProcessOptions(d),
            j = a.plotGroup("dataLabelsGroup", "data-labels", d.defer ? "hidden" : "visible", d.zIndex || 6), p(d.defer, !0) && (j.attr({
                opacity: +h
    ...
    O.prototype.alignDataLabel = function(a, b, c, d, e) {
        ...
        if (a = this.visible && (a.series.forceDL || f.isInsidePlot(h, v(i), g) || d && f.isInsidePlot(h, g ? d.x + 1 : d.y + d.height - 1, g))) d = r({
            ...
            align: c.align
        }) : (b.align(c, null, d), g = b.alignAttr, p(c.overflow, "justify") ===
                        ...
                        if (n > 0) {
                            ...
                            for (z = 0; z < K; z++) {
                                ...
                                if (E < z && G[z] !== null) E = z;
                                    ...
                                    for (w < K - z + E && G[z] !== null && (E = w - K + z); G[E] === null;) E++;
                                M.push({
                                    i: E,
                                    y: G[E]
                                });
