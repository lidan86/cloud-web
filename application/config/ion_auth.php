 ...
 */
$config['site_title']                 = "ICORE";		     // Site Title, example.com
$config['admin_email']                = "mailreko@gmail.com";  // Admin Email, admin@example.com
...
$config['user_expire']                = 1200;                // How long to remember the user (seconds). Set to zero for no expiration
...
$config['error_end_delimiter']     = '<br />';	// Error mesage end delimiter

$config['prefix']     = 'io';	// Prefix for register user.  io_username, etc...
