...
class Grocery_CRUD extends grocery_CRUD_States
{
	...
	protected $default_language_path				= '_assets/grocery_crud/languages';
	protected $default_config_path					= '_assets/grocery_crud/config';
	protected $default_assets_path					= '_assets/grocery_crud';
...
//@todo ui_day, ui_month, ui_year has to be lang strings
	...
	public function set_field_upload($field_name, $upload_dir = '')
	{
		$upload_dir = !empty($upload_dir) && substr($upload_dir,-1,1) == '/'
						...
						: $upload_dir;
		$upload_dir = !empty($upload_dir) ? $upload_dir : '_assets/uploads/files';
