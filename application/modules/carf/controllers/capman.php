...
class capman extends AdminController {
    ...
    public function index(){
        ...
        $crud->required_fields('pd_pic','email','mobile');
                $crud->edit_fields('pd_pic' ,'email','mobile','flag_form','updated_at');
