<?php
class pack_detail extends AdminController {
        ...
        $crud->callback_before_update(array($this,'callback_before'));
                $crud->set_lang_string('update_success_message',
                 ...
                 <script type="text/javascript">
                  window.location = "'.base_url().'carf/cs_tools/index/edit/'.$this->uri->segment(5).'";
                 </script>
