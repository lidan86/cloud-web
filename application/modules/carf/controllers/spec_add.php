<?php
class spec_add extends AdminController {
    ...
    public function index(){
        ...
        $crud = $this->new_crud();
                $crud->set_table('carf');
                $crud->set_subject('(CARF) - Specific Additional Information');
                $crud->columns('project_name');
                $crud->unset_add();$crud->unset_delete();$crud->unset_list();
                $crud->unset_export();$crud->unset_print();
                $crud->unset_back_to_list();
                $crud->edit_fields('additional_modul_mobile','additional_modul_mobile_others','roaming_int_mobile','roaming_int_mobile_other',
                        'additional_modul_broadband','additional_modul_broadband_other','roaming_int_broadband','roaming_int_broadband_others',
                        'srv_param','additional_modul_blackberry','other_modul_blackberry','roaming_int_blackberry','additional_modul_vas','additional_modul_vas_orhers','flag_form','updated_at');
                $crud->display_as('additional_modul_mobile','Additional Modul Mobile')
                    ->display_as('additional_modul_mobile_others','pls specify')
                    ->display_as('roaming_int_mobile','Roaming International')
                    ->display_as('roaming_int_mobile_other','existing')
                    ->display_as('additional_modul_broadband','Additional Modul Broadband')
                    ->display_as('additional_modul_broadband_other','pls specify')
                    ->display_as('roaming_int_broadband','Roaming International Broadband')
                    ->display_as('roaming_int_broadband_others','Others')
                    ->display_as('srv_param','SRV Parameter')
                    ->display_as('additional_modul_blackberry','Additional Modul Blackberry')
                    ->display_as('other_modul_blackberry','pls specify')
                    ->display_as('roaming_int_blackberry','Roaming International Blackberry')
                    ->display_as('additional_modul_vas','Additional Modul VAS')
                    ->display_as('additional_modul_vas_orhers','pls specify');
                 $crud->set_relation('additional_modul_mobile','m_modul_mobile','name');
        $crud->change_field_type('flag_form','invisible')
            ->change_field_type('updated_at','invisible');
        $crud->set_relation('roaming_int_mobile','m_roaming','name');
        $crud->set_relation('roaming_int_broadband','m_roaming','name');
        $crud->set_relation('additional_modul_broadband','m_modul_broadband','name');
        $crud->set_relation('srv_param','m_modul_srv','name');
        $crud->set_relation('additional_modul_blackberry','m_modul_blackberry','name');
        $crud->set_relation('roaming_int_blackberry','m_roaming_blackberry','name');
        $crud->set_relation('additional_modul_vas','m_modul_vas','name');
