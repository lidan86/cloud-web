    ...
    <div class="col-md-12">
        <div class="block block-drop-shadow">
            <div class="head bg-default bg-light-rtl">
                <h2>CAPACITY VERIFICATION PROCESS (CVP)</h2>
    ...
    <div class="col-md-12">
        <div class="block block-drop-shadow">
            ...
            <div class="content list">
                ...
                <?php
                $proses='';$status='';$pbar='';
                    if ($isi['approval']==5) {$proses = '25'; $pbar ='progress-bar'; $status='Need Capture & Validate IT ... !';};
                ...
                <div class="list-item">
                    ...
                    <div class="list-info">
                        <img src="<?php echo base_url() ?>_assets/img/example/user/dmitry.jpg" class="img-circle img-thumbnail">
                    </div>
                    <div class="list-text">
                        ...
                        <p>Last comment : <?php echo Modules::run('carf/ambilpesan', $isi['id']); ?> | By : <?php echo Modules::run('carf/pesanoleh', $isi['id']); ?></p>
