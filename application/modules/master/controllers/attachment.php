...
class Attachment extends AdminController
{
    ...
    public function index()
    {
        $crud = new grocery_CRUD();
                $crud->set_table('m_attachment');
                $crud->set_subject('Attachment Category');
                $crud->set_theme('datatables');
                $crud->required_fields('attachment_name');
                $crud->columns('attachment_name');
                $crud->add_fields('attachment_name');
                $crud->fields('attachment_name',
