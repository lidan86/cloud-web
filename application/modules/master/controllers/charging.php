...
class Charging extends AdminController
{
    ...
    public function index()
    {
        $crud = new grocery_CRUD();
                $crud->set_table('m_charging_by');
                $crud->set_subject('Charging');
                $crud->set_theme('datatables');
                $crud->required_fields('name');
                $crud->columns('name');

                $crud->fields('name');
                $crud->display_as('name','Charging');
