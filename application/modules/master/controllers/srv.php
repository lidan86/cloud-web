...
class Srv extends AdminController
{
    ...
    public function index()
    {
        $crud = new grocery_CRUD();
                $crud->set_table('m_modul_srv');
                $crud->set_subject('Modul SRV');
                $crud->set_theme('datatables');
                $crud->required_fields('name');
                $crud->columns('name');

                $crud->fields('name');
                $crud->display_as('name','Modul SRV');
