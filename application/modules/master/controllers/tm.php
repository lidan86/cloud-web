...
class Tm extends AdminController
{
    ...
    public function index()
    {
        $crud = new grocery_CRUD();
                $crud->set_table('m_pi_prepaid');
                $crud->set_subject('Target Market');
                $crud->set_theme('datatables');
                $crud->required_fields('name');
                $crud->columns('name');

                $crud->fields('name');
                $crud->display_as('name','Target Market');
