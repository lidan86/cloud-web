    ...
    <div class="col-md-6">
        <div class="block">
            ...
            <div class="content controls">
                <form method="post" action="<?php echo base_url().'index.php/nedetail/do_update'; ?> ">
                    ...
                    <div class="form-row">
                        ...
                        <div class=col-md-9><input type=text class="form-control" name="years" value="<?php echo $years;?>" placeholder="years "/></div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3"  class="form-control" >Low Range</div>
                        <div class=col-md-9><input type=text class="form-control" name="low_range" value="<?php echo $low_range;?>" placeholder="low range"/></div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3"  class="form-control" >Middle Range</div>
                        <div class=col-md-9><input type=text class="form-control" name="middle_range" value="<?php echo $middle_range;?>" placeholder="middle range "/></div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3"  class="form-control" >High Range</div>
                        <div class=col-md-9><input type=text class="form-control" name="high_range" value="<?php echo $high_range;?>" placeholder="high range"/></div>
                    </div>
                    <div class="form-row">
                        <div class="col-md-3"  class="form-control" >Initial Value</div>
                        <div class=col-md-9><input type=text class="form-control" name="initial_value" value="<?php echo $initial_value;?>" placeholder="initial value "/></div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class=col-md-9>
                            <select class="form-control" id="initial_master_ne_unit_id" name="initial_master_ne_unit_id">
                                ...
                                foreach($result as $row) {
                                    if ($row['id'] == $initial_master_ne_unit_id) {
                                        echo("<option selected='selected' value='" . $row['id'] . "'>" . $row['unit_name'] . "</option>");
                    ...
                    <div class="form-row">
                        ...
                        <div class=col-md-9><input type=text class="form-control" name="cost_value" value="<?php echo $cost_value;?>" placeholder="cost value"/></div>
                    </div>
                    <div class="form-row">
                        ...
                        <div class=col-md-9>
                            <select class="form-control" id="cost_master_ne_unit_id" name="cost_master_ne_unit_id">
                                <?php
                                foreach($result as $row) {
                                    if ($row['id'] == $cost_master_ne_unit_id) {
                                        echo("<option selected='selected' value='" . $row['id'] . "'>" . $row['unit_name'] . "</option>");
                    ...
                    <div class="form-row">
                        ...
                        <div class=col-md-9><input type=text class="form-control" name="remark" value="<?php echo $remark;?>" placeholder="remark"/></div>
                    </div>
