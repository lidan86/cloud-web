...
if (! function_exists('site_url'))
{
	...
	{
		$CI =& get_instance();
		return $CI->config->site_url($uri, $base_url);
	}
}
 ...
 * Normalize UTF Chars
 *
 * Takes a string and replaces all double, 
 * accented, and irregular latin characters 
 * into theie regular latin counterparts
 *
 * @access	public
 * @param	string	the string
 * @return	string
 */
if (! function_exists('string_normalize'))
{
