...
class Paypal_Lib {
	...
	function Paypal_Lib()
	{
		...
		$this->ipn_log_file = $this->CI->config->item('payment_lib_ipn_log_file');
		$this->ipn_log = $this->CI->config->item('payment_lib_ipn_log'); 
		
		$this->button_path = $this->CI->config->item('payment_lib_button_path');
		...
		$this->add_field('currency_code', $this->CI->config->item('payment_lib_currency_code'));
	...
	function validate_ipn()
	{
		...
		if (strstr("VERIFIED", $this->ipn_response))
		{
